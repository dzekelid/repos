...
- name: Bitbucket Get Repositories Username Repo Slug Refs Branches Name
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-refs-branches-name-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-refs-branches-name-get-postman.md
x-common:
- type: x-developer
