...
- name: Bitbucket Parameters Repositories Username Repo Slug Refs Branches
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-refs-branches-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-refs-branches-parameters-postman.md
x-common:
- type: x-developer
