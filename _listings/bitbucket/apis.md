...
- name: Bitbucket Parameters Repositories Username Repo Slug Default Reviewers
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-default-reviewers-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-default-reviewers-parameters-postman.md
x-common:
- type: x-developer
