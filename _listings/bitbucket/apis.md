...
- name: Bitbucket Delete Repositories Username Repo Slug Pipelines Config Ssh Known
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-pipelines-config-ssh-known-hosts-known-host-uuid-delete.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-pipelines-config-ssh-known-hosts-known-host-uuid-delete-postman.md
x-common:
- type: x-developer
