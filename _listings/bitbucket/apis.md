...
- name: Bitbucket Add Repositories Username Repo Slug Pipelines Config Variables
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-pipelines-config-variables-post.md
x-common:
- type: x-developer
