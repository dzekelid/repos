...
- name: Bitbucket Parameters Repositories Username Repo Slug Src Node Path
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-src-node-path-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-src-node-path-parameters-postman.md
x-common:
- type: x-developer
