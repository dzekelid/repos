...
- name: Bitbucket Get Repositories Username Repo Slug Pullrequests Pull Request  Patch
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-pullrequests-pull-request-id-patch-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-pullrequests-pull-request-id-patch-get-postman.md
x-common:
- type: x-developer
