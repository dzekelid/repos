...
- name: Bitbucket Delete Repositories Username Repo Slug Default Reviewers Target
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-default-reviewers-target-username-delete.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/bitbucket/repositories-username-repo-slug-default-reviewers-target-username-delete-postman.md
x-common:
- type: x-developer
