...
- name: Github Get Repos Owner Repo Git Refs Ref
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/github/repos-owner-repo-git-refs-ref-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/github/repos-owner-repo-git-refs-ref-get-postman.md
x-common:
- type: x-net-library
