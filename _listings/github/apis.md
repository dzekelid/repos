...
- name: Github Get Repos Owner Repo Compare Base ... Head
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/github/repos-owner-repo-compare-baseid-headid-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/repos/master/_listings/github/repos-owner-repo-compare-baseid-headid-get-postman.md
x-common:
- type: x-net-library
